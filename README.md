...
Probo là nền tảng GRC mã nguồn mở, cung cấp các thành phần nền như quản lý tuân thủ, rủi ro, kiểm soát, audit, evidence, task, tài liệu, phân quyền, audit log, web console, CLI, MCP API và GraphQL API.
...
Dự án kế thừa giấy phép của mã nguồn gốc Probo theo file `LICENSE`.
...
Vui lòng không xóa thông tin bản quyền và giấy phép gốc của Probo nếu mã nguồn vẫn sử dụng hoặc kế thừa từ Probo.
