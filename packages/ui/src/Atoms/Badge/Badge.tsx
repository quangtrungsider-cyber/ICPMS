...
const badge = tv({
  ...
  variants: {
    variant: {
      success: "bg-success text-txt-success border border-border-success/30",
      warning: "bg-warning text-txt-warning border border-border-warning/30",
      danger: "bg-danger text-txt-danger border border-border-danger/30",
      info: "bg-info text-txt-info border border-border-info/30",
