...
export function IconPeopleAdd({ size = 24, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" className={className} xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M12.0001 12C8.64237 12 5.96263 13.7661 4.55269 16.3886C3.92347 17.5589 4.16063 18.7737 4.85818 19.6414C4.94234 19.7461 5.03305 19.8459 5.12964 19.9403C5.80579 20.6011 6.77021 21 7.79536 21H15C13.3518 21 12.014 19.6708 12.0001 18.0259V17.9741C12.014 16.3292 13.3518 15 15 15C15 14.1762 15.3321 13.4299 15.8696 12.8878C14.7979 12.3519 13.5769 12.0375 12.2446 12.0031C12.1635 12.0011 12.082 12 12.0001 12Z" fill="currentColor" />
