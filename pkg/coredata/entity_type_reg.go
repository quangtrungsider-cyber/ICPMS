...
const (
	...
	IcpmsDocumentEntityType                        uint16 = 102
	IcpmsDocumentVersionEntityType                 uint16 = 103
	IcpmsDocumentFileEntityType                    uint16 = 104
	IcpmsIngestionJobEntityType                    uint16 = 105
	IcpmsExtractedTextBlockEntityType              uint16 = 106
	IcpmsDocumentParseJobEntityType                uint16 = 107
	IcpmsParsedDocumentSectionEntityType           uint16 = 108
	IcpmsRequirementEntityType                     uint16 = 109
	IcpmsRequirementGenerationJobEntityType        uint16 = 110
	IcpmsAiReviewJobEntityType                     uint16 = 111
	IcpmsAiReviewSuggestionEntityType              uint16 = 112
	IcpmsChecklistEntityType                       uint16 = 113
	IcpmsAssignmentEntityType                      uint16 = 114
	IcpmsAiConfigEntityType                        uint16 = 115
)
...
func NewEntityFromID(id gid.GID) (any, bool) {
	...
	case IcpmsDocumentEntityType:
		return &IcpmsDocument{ID: id}, true
	case IcpmsDocumentVersionEntityType:
		return &IcpmsDocumentVersion{ID: id}, true
	case IcpmsDocumentFileEntityType:
		return &IcpmsDocumentFile{ID: id}, true
	case IcpmsIngestionJobEntityType:
		return &IcpmsIngestionJob{ID: id}, true
	case IcpmsExtractedTextBlockEntityType:
		return &IcpmsExtractedTextBlock{ID: id}, true
	case IcpmsDocumentParseJobEntityType:
		return &IcpmsDocumentParseJob{ID: id}, true
	case IcpmsParsedDocumentSectionEntityType:
		return &IcpmsParsedDocumentSection{ID: id}, true
	case IcpmsRequirementEntityType:
		return &IcpmsRequirement{ID: id}, true
	case IcpmsRequirementGenerationJobEntityType:
		return &IcpmsRequirementGenerationJob{ID: id}, true
	case IcpmsAiReviewJobEntityType:
		return &IcpmsAiReviewJob{ID: id}, true
	case IcpmsAiReviewSuggestionEntityType:
		return &IcpmsAiReviewSuggestion{ID: id}, true
	case IcpmsChecklistEntityType:
		return &IcpmsChecklist{ID: id}, true
	default:
		return nil, false
	}
}
