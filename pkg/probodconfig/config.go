...
type (
	...
	Config struct {
		...
		ICPMSOCRService ICPMSOCRServiceConfig `json:"icpms-ocr-service"`
	}

	// ICPMSOCRServiceConfig holds connection settings for the ICPMS OCR microservice.
	ICPMSOCRServiceConfig struct {
		URL            string `json:"url"`
