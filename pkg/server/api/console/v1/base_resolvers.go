...
func (r *queryResolver) Node(ctx context.Context, id gid.GID) (types.Node, error) {
	...
	case coredata.IcpmsDocumentEntityType:
		action = probo.ActionDocumentGet
		loadNode = func(ctx context.Context, scope *coredata.Scope, id gid.GID) (types.Node, error) {
			document, err := r.probo.IcpmsDocuments.Get(ctx, scope, id)
			if err != nil {
				return nil, err
			}

			return types.NewIcpmsDocument(document), nil
		}
	case coredata.IcpmsDocumentVersionEntityType:
		action = probo.ActionDocumentGet
		loadNode = func(ctx context.Context, scope *coredata.Scope, id gid.GID) (types.Node, error) {
			version, err := r.probo.IcpmsDocumentVersions.Get(ctx, scope, id)
			if err != nil {
				return nil, err
			}
	...
	case coredata.IcpmsDocumentFileEntityType:
		action = probo.ActionDocumentGet
		loadNode = func(ctx context.Context, scope *coredata.Scope, id gid.GID) (types.Node, error) {
			file, err := r.probo.IcpmsDocumentFiles.GetByID(ctx, scope, id)
			if err != nil {
				return nil, err
			}
