      ...
      <Tbody>
        {samlConfigurations.map(({ node: config }) => (
          <Tr key={config.id}>
            ...
            <Td>
              <span
                className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${config.domainVerifiedAt
            ...
            <Td>
              <span
                className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${config.enforcementPolicy !== "OFF"
                    ? "bg-green-100 text-green-800"
