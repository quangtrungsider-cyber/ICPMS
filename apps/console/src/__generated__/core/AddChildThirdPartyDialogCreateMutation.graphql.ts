/**
 * @generated SignedSource<<bdf2cdae322ea05258a090aeca12d3cb>>
...
export type AddChildThirdPartyDialogCreateMutation$variables = {
  input: CreateThirdPartyInput;
};
export type AddChildThirdPartyDialogCreateMutation$data = {
  readonly createThirdParty: {
...
export type AddChildThirdPartyDialogCreateMutation = {
  response: AddChildThirdPartyDialogCreateMutation$data;
  variables: AddChildThirdPartyDialogCreateMutation$variables;
};
...
v1 = [
  {
    ...
    "concreteType": "CreateThirdPartyPayload",
    "kind": "LinkedField",
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "AddChildThirdPartyDialogCreateMutation",
    "selections": (v1/*: any*/),
    "type": "Mutation",
    "abstractKey": null
  },
  ...
  "params": {
    "cacheID": "d8d28de13cfbbfb5f1097216b2af7019",
    "id": null,
    "metadata": {},
    "name": "AddChildThirdPartyDialogCreateMutation",
    "operationKind": "mutation",
    "text": "mutation AddChildThirdPartyDialogCreateMutation(\n  $input: CreateThirdPartyInput!\n) {\n  createThirdParty(input: $input) {\n    thirdPartyEdge {\n      node {\n        id\n      }\n    }\n  }\n}\n"
  }
};
})();

(node as any).hash = "f4020a1014ba0d6e2ae2add3542012a1";
