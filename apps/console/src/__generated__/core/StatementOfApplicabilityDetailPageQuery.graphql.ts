/**
 * @generated SignedSource<<a225c20df678d7284fe44b5547828818>>
...
export type StatementOfApplicabilityDetailPageQuery$variables = {
  statementOfApplicabilityId: string;
};
export type StatementOfApplicabilityDetailPageQuery$data = {
  readonly node: {
...
export type StatementOfApplicabilityDetailPageQuery = {
  response: StatementOfApplicabilityDetailPageQuery$data;
  variables: StatementOfApplicabilityDetailPageQuery$variables;
};
  ...
  "args": [
    {
      "kind": "Literal",
      "name": "action",
      "value": "core:statement-of-applicability:update"
    }
  ],
  "kind": "ScalarField",
  "name": "permission",
  "storageKey": "permission(action:\"core:statement-of-applicability:update\")"
},
v8 = {
  "alias": "canDelete",
  "args": [
  ...
  "args": [
    {
      "kind": "Literal",
      "name": "action",
      "value": "core:statement-of-applicability:publish"
    }
  ],
  "kind": "ScalarField",
  "name": "permission",
  "storageKey": "permission(action:\"core:statement-of-applicability:publish\")"
},
v10 = {
  "alias": null,
  "args": null,
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "StatementOfApplicabilityDetailPageQuery",
    "selections": [
      {
        "alias": null,
        "args": (v1/*: any*/),
