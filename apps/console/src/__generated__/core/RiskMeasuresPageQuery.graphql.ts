/**
 * @generated SignedSource<<17f4004f48979dc536e4df9b6ba111bc>>
...
export type RiskMeasuresPageQuery$variables = {
  riskId: string;
};
export type RiskMeasuresPageQuery$data = {
  readonly node: {
...
export type RiskMeasuresPageQuery = {
  response: RiskMeasuresPageQuery$data;
  variables: RiskMeasuresPageQuery$variables;
};
...
return {
          ...
          (v2/*: any*/),
          {
            ...
            "selections": [
              ...
              (v5/*: any*/),
              {
                ...
                "kind": "LinkedField",
                "name": "__RiskMeasuresPage_measures_connection",
                "plural": false,
                "selections": [
                  {
                    "alias": null,
  ...
  "params": {
    "cacheID": "f396132c21765be0b1f5b8cececa3dd1",
    "id": null,
    "metadata": {
      "connection": [
        {
