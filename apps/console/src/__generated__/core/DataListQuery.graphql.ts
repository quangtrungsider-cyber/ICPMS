/**
 * @generated SignedSource<<5d982596f6212a28753a9b62c14067d6>>
...
return {
  ...
  "params": {
    "cacheID": "841084c1666910e1e692f10ed9206510",
    "id": null,
    "metadata": {},
    "name": "DataListQuery",
    "operationKind": "query",
    "text": "query DataListQuery(\n  $after: CursorKey = null\n  $before: CursorKey = null\n  $first: Int = 10\n  $last: Int = null\n  $order: DatumOrder = null\n  $id: ID!\n) {\n  node(id: $id) {\n    __typename\n    ...DataPageFragment_16fISc\n    id\n  }\n}\n\nfragment DataPageFragment_16fISc on Organization {\n  data(first: $first, after: $after, last: $last, before: $before, orderBy: $order) {\n    edges {\n      node {\n        id\n        name\n        dataClassification\n        owner {\n          fullName\n          id\n        }\n        thirdParties(first: 50) {\n          edges {\n            node {\n              id\n              name\n              websiteUrl\n            }\n          }\n        }\n        canUpdate: permission(action: \"core:datum:update\")\n        canDelete: permission(action: \"core:datum:delete\")\n        __typename\n      }\n      cursor\n    }\n    pageInfo {\n      endCursor\n      hasNextPage\n      hasPreviousPage\n      startCursor\n    }\n  }\n  id\n}\n"
  }
};
})();
